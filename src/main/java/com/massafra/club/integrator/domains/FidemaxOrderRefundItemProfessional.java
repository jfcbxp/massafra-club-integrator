...
@Builder
@Entity
@Table(name = "FIDEMAX_ORDER_REFUND_ITEMS_PROFESSIONAL")
public class FidemaxOrderRefundItemProfessional implements Serializable {
    ...
    private FidemaxOrderRefundProfessional order;
}
