...
@Builder
@Entity
@Table(name = "FIDEMAX_ORDER_REFUND_PROFESSIONAL")
public class FidemaxOrderRefundProfessional implements Serializable {
    ...
    private List<FidemaxOrderRefundItemProfessional> produtos;
}
