CREATE VIEW FIDEMAX_CUSTOMER AS
SELECT A1_COD AS CODIGO,A1_LOJA AS LOJA,A1_CGC AS CGC,A1_NOME AS NOME,A1_END AS ENDERECO,
CAST(A1_DTNASC AS DATE) AS DATA_NASCIMENTO,A1_DDD AS DDD,A1_TEL AS TELEFONE,ZFB.R_E_C_N_O_ AS REC,
