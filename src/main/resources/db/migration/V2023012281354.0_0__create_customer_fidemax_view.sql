...
CAST(A1_DTNASC AS DATE) AS DATA_NASCIMENTO,RTRIM(LTRIM(A1_DDD)) AS DDD,RTRIM(LTRIM(A1_TEL)) AS TELEFONE,RTRIM(LTRIM(A1_EMAIL)) AS EMAIL,ZFB.R_E_C_N_O_ AS REC,
